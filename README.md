...
- Achieved: 99.995% in pilot
- RAID-5: Survives single disk failure
- Blockchain: Survives 2 node failures (3/5 quorum)

**Disaster Recovery:**
- Recovery Time Objective (RTO): 4 hours
- Recovery Point Objective (RPO): 1 hour (hourly backups)
- Backup retention: 90 days
- Geographic redundancy: 2 data centers (Putrajaya + Cyberjaya)
...
- HSM (FIPS 140-2 Level 3) for production

### Quick Start
```bash
# Clone and setup
git clone https://github.com/malaysia-gov/obsidian-iron-vault.git
cd obsidian-iron-vault
python3 -m venv venv
...
cp .env.example .env
nano .env  # Set database credentials, API ports, blockchain nodes
...
# Load testing
locust -f tests/load/locustfile.py --host=http://localhost:5001 --users=1000
```
...
curl http://api.obsidian.gov.my/health
```
...
We welcome contributions from Malaysian developers and cybersecurity experts. Please read CONTRIBUTING.md for guidelines on code style, testing requirements, and pull request process.

### Development Guidelines

- Follow PEP 8 style (100 character line limit)
- Minimum 80% test coverage for new code
- Security-sensitive changes require code review from 2+ senior developers
- All cryptographic functions must have mathematical proof of correctness
...
**Proprietary - Malaysian Government**

This software is owned by the Government of Malaysia and intended for official use only. Unauthorized copying, distribution, or modification is strictly prohibited.

For commercial licensing inquiries: licensing@obsidian.gov.my

---

## Support

- **Technical Support**: support@obsidian.gov.my
- **Security Issues**: security@obsidian.gov.my (PGP key available)
- **Documentation**: https://docs.obsidian.gov.my
- **Status Page**: https://status.obsidian.gov.my

---

## Acknowledgments

Developed by Malaysia's top cybersecurity experts in collaboration with MAMPU, CyberSecurity Malaysia, NACSA, JPN, and PDSA.

**Built for Malaysia. Secured by mathematics. Governed by citizens.** 🇲🇾🔒

---

**Project Status**: Production-Ready | **Version**: 1.0.0 | **Last Updated**: December 2025
